...
export default {
  ...
  proxy_spec: {
    duration_tip:'When using a proxy, you can set the IP's lifespan and use the proxy throughout that time. Since it's a resident proxy, its lifespan can range from a few hours to several days.',
    list_tip: {
