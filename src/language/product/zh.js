...
export default {
  ...
  product_spec: {
    residential: {
      ...
      ques1: "什么是动态住宅代理？",
      ans1: "动态住宅代理由互联网服务提供商（ISP）提供。每个住宅IP都是可选择国家和城市的动态IP，可以帮助用户高效、安全地进行精确的地理选择和信息访问。IpStar提供真实的住宅IP，且连接成功率高达99.5%左右。",
    ...
    data_center: {
      ...
      desc: "借助我们的数据中心代理，您将获得无限的带宽，并且每个IP付费。",
      adv1: "高级静态 IP",
      adv2: "快速稳定不限流量",
      adv3: "IP 新鲜度高",
      ques1: "什么是静态数据中心代理？",
    ...
    isp_desc:
      "在全球任何国家或地区，只要您需要，我们都可以为您提供真实的静态住宅IP。覆盖全球50万+个原创住宅IP。业界最快，运行可靠稳定，不掉线、不中断。",
