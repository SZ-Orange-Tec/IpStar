export default  {
  ...
  PCFooter: {
    footerGetNow: {
      ...
      p: 'E-commerce , network  , big data , artificial intelligence , Ipflare helps you  develop rapidly',
      btnTxt: 'Get it now'
    },
    footer_serve: {
      footerServeLeft: {
        ...
        declare: 'IpFlare proxy services do not support direct requests within China, users must comply with the laws of your location to use IpFlare services, and we may discontinue the service without refund once risky behaviour is detected.'
      },
      footerServeRight: {
        h4: 'CONTACT US',
  ...
  PCHomePage: {
    ...
    welcomeTextP: 'Our residential-proxy network consists of real user IP addresses, which cannot be detected or blocked. The IP pool is continuously optimized and updated to ensure high availability of IPs and stable communication speeds.',
    btnSumOne: 'Try',
    btnSumTwo: 'Tutorials',
  ...
  PCObtainProxy: {
    ...
    heads_btn: 'Extract',
    popover: 'When you use a proxy, you can specify the lifetime of the IP or use it all the time during the alive  time of the IP. Because the proxy is a residential proxy, the alive time of the residential proxy is from a few hours to a few days.',
    btnSum: ['Show As Text', 'Show As Table', 'Copy To Clipboard'],
    Format: [
      'Each line in the following list is a set of proxy parameters. If you don\'t know how to use it, please',
      'click here',
      'for help.'
    ],
  ...
  PCConfigure: {
    ...
    url_note: {
      tag: 'Note: ',
      first: 'You can open this link in your browser or request this link in your code to get the IP proxy access point, each request will return a different IP access point, if you need more flexibility, please check the API reference documentation and demo source code.',
      second: "For repeated requests to this link, change the parameter 'rd' to a different random string each time; otherwise, the returned channel will not change."
    },
    // url_note: "\n",
  ...
  PCSettings: {
    ...
    tabContent: {
      ...
      popover: 'The API Key provides authorization for your program to request APIs. When you change the API Key, you need to modify your programs for continuing to run.',
      btnText: 'Regenerate',
      btnCopy: 'Copy'
    },
    tabContentTwo: {
  ...
  PCGettingStarted: {
    h3: 'Ipflare provides you with a high-quality proxy IP service.',
    pBox: {
      pOne: [
    ...
    content: {
      ...
      h4: ['3.1 About the "IP Proxy Channel"', '3.2 Obtain IP through the "Obtain Proxy" menu', '3.3 Obtain IP through IPflare API'],
      pBox: {
        one: [
        ...
        five: [
          'Ipflare provides APIs for obtaining IP proxy channels, which are convenient for different programming languages. The API reference will be displayed in the "API Reference" menu item of your management console after you purchase the products.',
  ...
  PCHelpContent: {
    ...
    a: 'All',
    h5: ['Example Of Integration With Proxy', 'Integraion With IPflare API']
  },
  PCAndroidAcess: {
    h3: 'Android Integration With IPflare',
    pBox: {
      one: 'IPflare supports almost all proxy APPs in Android, such as Postern and v2rayNG. Here we take v2rayNG as an example to learn how to setup settings and integrate proxy in android APP:',
      two: [
      ...
      three: 'The configuration has been completed. You can access "http://ip234.in" to test whether the proxy is normal and find out the foreign IP address, indicating that the proxy has been successful.'
    },
  ...
  PCAdsPowerAccess: {
    h3: 'ADSPower Integration With IPflare Proxy',
    list: [
      {
  ...
  PCBitbrowseAccess: {
    h3: 'BitBrowser Integration With IPflare Proxy',
  ...
  PCHubStudioAccess: {
    h3: 'HubStudio Integration With IPflare Proxy',
    h4: 'STEP 1: DOWNLOAD THE SOFTWARE',
  ...
  PCVmloginAccess: {
    h3: 'VMLogin Integration With IPflare Proxy',
    list: [
      {
  ...
  PCFaq: {
    ...
    pBox: {
      ...
      seven: [
        ...
        'The proxy user format of IPflare is generally "user-ipstr-0-county-N",',
      ...
      eight: 'We guarantee that most of the IPs is available. If this happens, please replace another IP channel. Ipflare only charges for valid IP, which means invalid IP will not cost.',
      nine: 'Ipflare has more than 20 million + residential IP addresses and is regularly updated to provide the cleanest IP pool.',
      ...
      ten2: 'Considering the potential risks, IPflare prohibits access to sensitive websites through proxy ip addresses, these websites include websites from high-risk areas, government websites, certain specific websites and so on, when you access these websites through the Ipflare proxy, you will get an error message that the target website has been blocked, if you have any questions, please consult our online customer service.Translated with DeepL.com (free version)',
      eleven: 'The white list is an optional option in Ipflare. With the white list function, you can limit the public IP addresses of servers or devices that access our services to the list you specify to protect your interests and security. You can find this function in the account settings of the management console, or you can maintain it via the APIs.'
    }
  },
  PCPayPopup: {
    detail: {
