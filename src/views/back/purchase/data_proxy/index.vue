    ...
    <div class="w-full box-border p-5 board rounded table_box space-y-3">
      <div class="table_box">
        <el-table :data="tableData" style="width: 100%" v-loading="loading">
          <el-table-column prop="num" :label="$t('Number')" min-width="120"></el-table-column>
          ...
          <el-table-column prop="price" :label="$t('Price')" min-width="240"></el-table-column>
          ...
          <template #empty>
            <div class="column_center space-y-5 py-10" v-if="!loading && tableData.length < 1">
              ...
              <RouterLink to="/data_center?active=0">
