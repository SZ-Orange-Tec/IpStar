export default [
  ...
  },
  {
    ...
    tbody: [
      [
        ...
        'Yes',
        'String',
        '请求API的授权密钥。注册完成后，可以在平台的账号设置信息中找到。'
      ],
      [
        'Session',
        'No',
      ...
      [
        ...
        'No',
        'Int',
        '当该值为1时，在keeptime后会自动修改IP'
      ],
      [
        'Region',
        'No',
        'String',
        '区域代码参见区域代码表。如果该值为空，则表示它是在全球范围内随机获得的。'
      ],
      [
        'Restype',
        'No',
        'Int',
        '指定返回数据的格式。当该变量的值为0时，返回json数据;否则，将返回简短格式的数据。'
      ],
  ...
  },
  {
    ...
    title: '返回数据参数:',
    thead: ['名称', '描述'],
    tbody: [['Code', '如果成功则返回0，否则返回错误码'], ['Msg', '错误消息']]
  },
  // 2.partner API
  {
    type: 'bigParagraph',
  ...
  },
  {
    ...
    tbody: [
      ['Token', 'Yes', 'String', '登录后获得的凭证'],
      ['Cust_ Code', 'Yes', 'String', '子帐号的用户号码。可选参数。如果传入该参数，则返回子账号的流量报表。如果它为空，则返回由令牌表示的主帐户下的所有子帐户的数据的每日摘要'],
  ...
  },
  {
    ...
    tbody: [
      ['Token', 'Yes', 'String', '登录后获得的凭证'],
      ['Cust_ Code', 'Yes', 'String', '子帐户用户号码。可选参数。如果传入该参数，则返回子账号的流量报表。如果为空，则将返回该令牌所表示的主帐户下所有子帐户数据的每日消费详细信息'],
      ['Begin_ Day', 'Yes', 'String', '开始日期'],
      ['End_ Day', 'Yes', 'String', '结束日期']
    ]
  },
