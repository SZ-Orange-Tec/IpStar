<template>
  <div class="residential-proxy space-y-6 column">
    <div class="w-full p-5 board rounded">
      ...
      <div class="w-full between mb-8">
        <div class="v_center space-x-3">
          <div class="w-10 h-10 rounded-full bg-blue-50 vh_center">
            <img src="/logo.webp" alt="住宅代理" class="w-6 h-6" />
          </div>
          <div>
    ...
    <Tab v-model="active" activeBgColor="#1C1C20" activeTextColor="#ffffff" class="p-2 rounded tab text-sm">
